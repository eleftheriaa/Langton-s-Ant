        ...
        while 1:
            try:
                ...
                if a == (0, 0, 0):
                    ...
                    pygame.draw.rect(self.window, (122,55,139), rect, 1)
                elif a == (122,55,139):
                    direction = (direction + 1) % 4 # turn left
                    pygame.draw.rect(self.window, (60,179,113), rect, 1)
                elif a == (60,179,113):
                    direction = (direction + 3) % 4 # turn right
                    pygame.draw.rect(self.window, (205,145,158), rect, 1)
                else :
                    direction = (direction + 3) % 4 # turn right
...
# RLLR - Produces a vertically symmetrical box, light on one side, dark on the other, chaos in the middle.