        ...
        while 1:
            try:
                ...
                if a == (0, 0, 0):
                    ...
                    pygame.draw.rect(self.window, (124,252,0), rect, 1)
                elif a == (124,252,0):
                    direction = (direction + 3) % 4 # turn right
                    pygame.draw.rect(self.window, (75,0,130), rect, 1)
                elif a == (75,0,130):
                    direction = (direction + 3) % 4 # turn right
                    pygame.draw.rect(self.window, (255,99,71), rect, 1)
                else :
                    direction = (direction + 1) % 4 # turn left
...
# RRLL - A vertically symmetrical shape. Looks like a sideways peach or a scan of the brain.